...
LineAgeView = require './line-age-view'
...
class FileView extends View
  @content: ->
    @div class: 'col-md-3 file-view', =>
      @div class: 'panel bordered', =>
        ...
        @div class: 'panel-body padded file-body', outlet: 'body', =>
          @div class: 'stats', =>
  ...
  initialize: ({@path, @lines, numberOfCommits, numberOfAuthors, averageAge, oldestLine, newestLine}) ->
    ...
    @averageAge.text("Average age of lines: #{@millisecondsToDays(averageAge)} days")
    ...
    @body.append(new LineAgeView(@lines, oldestLine))
